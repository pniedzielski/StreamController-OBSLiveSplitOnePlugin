...
class OBSLiveSplitOnePlugin(PluginBase):
    def __init__(self):
        ...
        toggle_timing_method_action_holder = ActionHolder(
            ...
            action_name=self.locale_manager.get(
                "actions.toggle-timing-method.name"
            ),
